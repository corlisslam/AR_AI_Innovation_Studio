...
{
    private ARTrackedImageManager _trackedImageManager; // Define instance of the class ARTrackedImageManager
    ...
    // eventArgs is an instance of ARTrackedImagesChangedEventArg
    {
    ...
    private void InstantiatePrefabs() // This method updates the AR content for a given tracked image.
    {
        //if (worldAnchor == null) return;
        List<GameObject> instantiatedObjects = new List<GameObject>();

        GameObject anchorObject = new GameObject("AnchorObject");
        anchorObject.transform.position = arCamera.transform.position;
        anchorObject.transform.rotation = arCamera.transform.rotation;
        ...
        {
            GameObject instantiatedPrefab = Instantiate(item.prefab, anchorObject.transform);
            ...
            instantiatedPrefab.transform.parent = anchorObject.transform;
            ...
            //var instantiatedPrefab = Instantiate(item.prefab, item.positionOffset, Quaternion.Euler(item.rotationOffset));
            //instantiatedPrefab.transform.localScale = item.scale;
